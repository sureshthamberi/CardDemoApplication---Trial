...
- Name: regression\accounts-payments-cards.spec.js >> Regression - Accounts, Payments, Cards >> user can search account, navigate to payment, and verify cards
- Location: tests\regression\accounts-payments-cards.spec.js:10:3
